...
public class GenUtils {
	...
	public static List<String> getTemplates(){
		...
		templates.add("template/ErrorCode.java.vm");
	...
	public static void generatorCode(Map<String, String> table,
		...
		for(String template : templates){
			...
			if(template.contains("Constant.java.vm"))continue;
			if(template.contains("ErrorCode.java.vm"))continue;
//			if(template.contains("Constant.java.vm")&&f1)continue;
//			if(template.contains("ErrorCode.java.vm")&&f2)continue;
//			if(template.contains("Constant.java.vm"))f1=true;
//			if(template.contains("ErrorCode.java.vm"))f2=true;
	...
	public static String tableToJava(String tableName, String tablePrefix) {
		if(StringUtils.isNotBlank(tablePrefix)){
			String[] ps = tablePrefix.split("\\.");
			for(int i=0; i<ps.length; i++){
				tableName = tableName.replace(ps[i], "");
			}
//			tableName = tableName.replace(tablePrefix, "");
	...
	public static String getFileName2(String template, String className, String packageName){
		...
		String moduleName = "";
		String platformorVatbe = "acme-sale";

		if(StringUtils.isNotBlank(packageName)){
			if(packageName.contains("platform"))platformorVatbe = "platform";
		...
		String domainAPIPath = platformorVatbe+"-" + moduleName+"-domain-api" + File.separator ;
		String appPath =platformorVatbe+"-"+moduleName+"-app" + File.separator;
		String domainServicePath = platformorVatbe+"-"+moduleName+"-domain" + File.separator;
		String repositoryPath =  platformorVatbe+"-"+moduleName+"-repository"+ File.separator;
		String webPath = platformorVatbe+"-"+moduleName+"-web"  + File.separator  + "src" + File.separator ;
		...
		if(template.contains("Constant.java.vm")){
			return domainAPIPath  + packagePath + "domain" + File.separator + "common" + File.separator +  "Constant.java";
		}
		if(template.contains("ErrorCode.java.vm")){
			return domainAPIPath  + packagePath + "domain" + File.separator + "common" + File.separator +  "ErrorCode.java";
		}
